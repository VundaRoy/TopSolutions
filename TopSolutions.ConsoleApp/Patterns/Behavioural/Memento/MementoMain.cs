namespace TopSolutions.ConsoleApp.Patterns.Behavioural.Memento
{
    public class MementoMain
    {
        static void Main()
        {
            ...
            {
                LedTV = new LEDTV("42-Inch", "60000", false, true, true)
            };
            ...
            originator.LedTV = new LEDTV("46-Inch", "80000", true, true, false);
            ...
            originator.LedTV = new LEDTV("50-Inch", "100000", true, false, false);
