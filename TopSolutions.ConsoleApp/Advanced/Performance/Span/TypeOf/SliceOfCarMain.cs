...
namespace TopSolutions.ConsoleApp.Advanced.Performance.Span.TypeOf
{
    public class SliceOfCarMain
    {
        public static void Main(string[] args)
        {
            ...
            {
                new Car { Model = "Model S", Name = "Tesla", Price = 80000, Maker = "Tesla" },
                new Car { Model = "Mustang", Name = "Ford", Price = 55000, Maker = "Ford" },
                new Car { Model = "Civic", Name = "Honda", Price = 25000, Maker = "Honda" },
                new Car { Model = "Camry", Name = "Toyota", Price = 30000, Maker = "Toyota" },
                new Car { Model = "Accord", Name = "Honda", Price = 28000, Maker = "Honda" }
            };
